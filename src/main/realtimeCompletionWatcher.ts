/**
 * Realtime Conductor — completion watcher (card rt-12, Phase 2, "respond when done").
 *
 * When voice-Conductor DISPATCHES work (fire-and-notify, the default pattern), he does
 ...
 * make Conductor speak it unprompted ("Oscar finished — want details?").
 *
...
/** A unit of work voice-Conductor dispatched and is now awaiting completion of. */
 ...
 * field here reaches Conductor. `summary` is the human-speakable line; `completedAt` is
 ...
 * whitespace, and cap length so a malicious objective can't steer what Conductor says or does.
