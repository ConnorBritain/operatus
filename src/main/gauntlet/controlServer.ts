...
/**
 * Authenticated, line-delimited local control plane used by Atelier-launched
  ...
  constructor(
    ...
    this.endpoint = {
      ...
      socketPath: process.platform === 'win32'
        ? `\\\\.\\pipe\\atelier-gauntlet-${createHash('sha256').update(stateRoot).digest('hex').slice(0, 24)}`
