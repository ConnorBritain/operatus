...
export class PrimitiveRegistry {
  ...
  resolveGeneralEngineeringCritic(provider: 'claude' | 'codex'): { prompt: string; receipts: PrimitiveReceipt[] } {
    ...
    const prompt = [
      '# Operatus General Engineering Critic',
      '',
      'You are a fresh, independent, read-only critic. You did not implement this artifact.',
      'Evaluate the exact commit and frozen bar supplied by Operatus. Inspect the real diff, tests, logs, and application evidence.',
      ...
      'Return Operatus structured JSON only; the Conductor, not you, is final authority.',
      '',
