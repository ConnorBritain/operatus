/**
 * Realtime Conductor — completion toast (card rt-12, Phase 2, the visual half of
 * "respond when done").
 *
 * When voice-Conductor dispatches work fire-and-notify, main detects completion (see
 * src/main/realtimeCompletionWatcher.ts) and — while a session is live — pushes the
 * event to the renderer over the `realtime:completion` channel. Conductor SPEAKS it; this
 ...
 *  human-speakable line Conductor relays; the rest is context for this toast. */
    ...
    >
      {toasts.map((t) => (
        ...
        >
          ...
          >
            <Icon name="bell" /> Conductor · completed
            <button
              type="button"
