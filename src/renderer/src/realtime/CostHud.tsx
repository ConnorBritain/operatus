/**
 * Realtime Conductor — voice session cost HUD (card rt-9, cost-guard).
 *
 ...
 * near the voice toggle (Conductor's card / fullscreen header) — it renders its own
 ...
 *    so the user (and Conductor, who can read get_cost) knows to wrap up. The actual
