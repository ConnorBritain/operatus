...
const SLACK_CONNECT_STEPS = `Connect Operatus to Slack

1. api.slack.com/apps -> Create New App -> From scratch. Name it
   "Operatus" and pick your workspace.
...
8. Save Changes, reinstall if Slack prompts, then invite the bot
   to your channel:  /invite @Operatus`;
...
export function SettingsModal({ config, onClose, initialSection }: SettingsModalProps) {
  ...
  // Talk (Realtime Conductor) is gated on the OpenAI key — read the live presence
  // boolean so the Realtime Conductor section can show its enabled/disabled status.
            ...
            <>
              <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
                ...
                <div style={{
                  ...
                  {activeSection === 'Agents & Models' && (
                    <>
                      <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                          <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                            Every newly spawned Claude agent (Conductor included) starts on this model unless picked per-agent.
                    ...
                    <>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                            ...
                            <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                              Pipe a Slack channel's messages straight into Conductor's queue.
                            </span>
                          </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        ...
                        <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                          ...
                          schema — edit that in the Triggers tab of Conductor's Command Center, where the history
                  ...
                  {/* VOICE — Free Flow dictation + Realtime Conductor (v0.3.4: its own tab) */}
                  {activeSection === 'Voice' && (
                    <>
                      ...
                      {/* Realtime Conductor — voice device selection (rt-8) */}
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <div style={{
                          fontFamily: 'var(--cth-font-display)', fontSize: 8, lineHeight: '12px',
                          color: 'var(--cth-ink-500)', textTransform: 'uppercase', marginBottom: 2
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                          <span style={{ fontSize: 13, lineHeight: '20px', color: 'var(--cth-ink-900)' }}>
                            Voice chat with Conductor
                          </span>
                          <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                            Talk to the orchestrator in real time. Toggle it on from Conductor's tab; choose which
                        ...
                        <div style={{
                          ...
                          <span style={{ fontSize: 12, lineHeight: '17px', color: 'var(--cth-ink-700)' }}>
                            Talking to Conductor runs on OpenAI&rsquo;s Realtime API — speech in, speech out, over a
                          ...
                          <span style={{
                            ...
                            {openAiVoiceNote || (hasOpenAiKey
                              ? 'Key saved — Talk is ready. Start it from Conductor’s card.'
