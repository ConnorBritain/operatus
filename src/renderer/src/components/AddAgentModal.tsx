...
const HIRE_PROMPT = `You are designing a "hire" — a ready-to-spawn AI agent for Operatus, an app that runs a team of CLI coding agents. Output ONE JSON object (a hire manifest) and nothing else.
