...
/**
 * Loader shown on the empty floor while the god agent ("Conductor") is clocking
 * in on launch. Replaces the "add agent" prompt so a returning user doesn't see
 * the empty-floor call-to-action before Conductor has booted.
 */
        ...
        <PixelPanel variant="dialog" title="CLOCKING IN" noPadding>
          <div style={{
            ...
            <p style={{
              ...
              Conductor is settling into the corner office and getting the floor
              ready. Hang tight…
            </p>
          </div>
        </PixelPanel>
