...
const FEATURES: Feature[] = [
  ...
  {
    icon: 'gear',
    label: 'YOUR CONDUCTOR LEADS',
    desc: 'The Conductor runs the floor — triages requests, routes tasks, and escalates only what needs you.',
    descPlain: 'Your Conductor takes requests, hands work to the right agent, and only interrupts you when it matters.',
    ...
    <div style={{
      ...
      <div style={{ width: 640, maxWidth: '94vw' }}>
        <PixelPanel
          variant="dialog"
          title={
            step === 'persona' ? 'WELCOME TO OPERATUS'
          ...
          <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--cth-ink-700)', lineHeight: '19px' }}>
                      Operatus turns the CLI agent you already use into a clone of you —
            ...
            {step === 'orchestrator' && (
              <>
                <p style={{ margin: 0, lineHeight: '22px' }}>
                  {plain ? (
                    <><strong>Conductor is your clone</strong> — he reads your requests, breaks
                    ...
                    <><strong>Conductor is your clone</strong> — the boss of the floor you just
            ...
            {step === 'permissions' && (
              <>
                ...
                <ToggleRow
                  ...
                  desc="A handful of anonymous events (app opened, agent spawned, feature used) that help improve Operatus — never prompts, code, file paths, or agent output. Full list in TELEMETRY.md; change anytime in Settings."
                  on={shareStats}
