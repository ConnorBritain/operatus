 ...
 * `atelier://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export const HIRE_SPEC_V1 = 'atelier/hire@1';
...
export interface HireManifest {
  /** Spec tag; exactly `atelier/hire@1` for this version. */
...
/** Parse a `atelier://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'atelier:') return null;
  // Both atelier://hire?src= (host) and atelier:hire?src= (path).
