 ...
 * `ventura://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export const HIRE_SPEC_V1 = 'ventura/hire@1';
...
export interface HireManifest {
  /** Spec tag; exactly `ventura/hire@1` for this version. */
...
/** Parse a `ventura://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'ventura:') return null;
  // Both ventura://hire?src= (host) and ventura:hire?src= (path).
