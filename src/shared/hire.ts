 ...
 * `operatus://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
export const HIRE_SPEC_V1 = 'operatus/hire@1';
...
export interface HireManifest {
  /** Spec tag; exactly `operatus/hire@1` for this version. */
...
/** Parse a `operatus://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'operatus:') return null;
  // Both operatus://hire?src= (host) and operatus:hire?src= (path).
