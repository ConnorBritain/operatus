...
Inherited feature specification, retained for the renderer's memory graph implementation.

---

## 1. Goal

Give the Conductor a single-glance answer to: *who is talking to whom, and what does the hive collectively know?*
