# Munder-to-Atelier migration map

| Concern | Reused runtime | Atelier boundary | Authority after migration |
|---|---|---|---|
...
| Floor | Pixi movement and stations | original Atelier map, neutral procedural sprites, run zones | projection only |
| Product profile | inherited Electron shell | new app ID, data namespace, deep link, updater/analytics defaults | Atelier-owned configuration |
